...
// import { TurboOptions, TurboTLSMethods, TurboTLSModes, SecureJsonData } from '../types';

// import { useAutoDetectFeatures } from './useAutoDetectFeatures';

// export const turboVersions: Array<SelectableValue<number>> = [
//   { label: '9.0', value: 900 },
//   { label: '9.1', value: 901 },
//   { label: '9.2', value: 902 },
//   { label: '9.3', value: 903 },
...
// export const TurboConfigEditor = (props: DataSourcePluginOptionsEditorProps<TurboOptions, SecureJsonData>) => {
//   const [versionOptions, setVersionOptions] = useState(turboVersions);
...
//   const tlsModes: Array<SelectableValue<TurboTLSModes>> = [
//     { value: TurboTLSModes.disable, label: 'disable' },
//     { value: TurboTLSModes.require, label: 'require' },
//     { value: TurboTLSModes.verifyCA, label: 'verify-ca' },
//     { value: TurboTLSModes.verifyFull, label: 'verify-full' },
//   ];

//   const tlsMethods: Array<SelectableValue<TurboTLSMethods>> = [
//     { value: TurboTLSMethods.filePath, label: 'File system path' },
//     { value: TurboTLSMethods.fileContent, label: 'Certificate content' },
//   ];

//   const onJSONDataOptionSelected = (property: keyof TurboOptions) => {
...
//   const onDSOptionChanged = (property: keyof TurboOptions) => {
...
//             options={tlsModes}
//             inputId="tlsMode"
//             value={jsonData.sslmode || TurboTLSModes.verifyFull}
...
//               options={tlsMethods}
//               inputId="tlsMethod"
//               value={jsonData.tlsConfigurationMethod || TurboTLSMethods.filePath}
...
//         </FieldSet>
//       )}
//       {jsonData.sslmode !== TurboTLSModes.disable ? (
//         <FieldSet label="TLS/SSL Auth Details">
//           {jsonData.tlsConfigurationMethod === TurboTLSMethods.fileContent ? (
//             <TLSSecretsConfig
//               showCACert={
//                 jsonData.sslmode === TurboTLSModes.verifyCA || jsonData.sslmode === TurboTLSModes.verifyFull
//               }
//               editorProps={props}
...
//           htmlFor="turboVersion"
//           label="Version"
//         >
//           <Select
//             value={jsonData.turboVersion || 903}
//             inputId="turboVersion"
//             onChange={onJSONDataOptionSelected('turboVersion')}
...
//         <Link rel="noreferrer" target="_blank" href="http://docs.grafana.org/features/datasources/turbo/">
